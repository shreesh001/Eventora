...
const FEATURES = [
    ...
    { icon: <FaTicketAlt />, title: 'Seamless Access', desc: 'Download tickets instantly or manage them right from your personal dashboard.' },
    { icon: <FaShieldAlt />, title: 'Secure Platform', desc: 'All transactions are protected by cutting-edge security and 2FA OTP technology.' },
];
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="relative bg-black text-white rounded-3xl overflow-hidden mb-12 shadow-2xl">
                ...
                <div className="relative p-10 md:p-20 text-center flex flex-col items-center z-10">
                    ...
                    <p className="text-gray-300 text-lg md:text-xl mb-10 max-w-2xl mx-auto font-light leading-relaxed">
                        Discover the best tech conferences, music festivals, and hands-on workshops in your area. Secure your spot today.
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-4">
                {FEATURES.map((f, i) => (
                    <div key={i} className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
            ...
            <div className="flex items-center justify-between mb-8 px-2 border-b border-gray-200 pb-4">
                ...
                <span className="text-gray-500 font-medium">{events.length} results found</span>
            </div>
                        ...
                        <div key={event._id} className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-xl transition flex flex-col">
                            ...
                            <div className="p-6 flex-grow flex flex-col">
                                ...
                                <div className="flex flex-col gap-2 mb-4 text-gray-600 text-sm">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <FaRegClock className="text-gray-400 shrink-0" />  {/* ✅ time field */}
                                ...
                                <div className="mt-auto">
                                    <div className="w-full bg-gray-200 rounded-full h-2 mb-2">
                                        <div
                                            ...
                                            style={{ width: `${getSeatPercent(event.availableSeats, event.totalSeats)}%` }}
                                        />
                                    </div>
            ...
            <footer className="mt-auto pt-16 pb-8 border-t border-gray-200 text-center">
                ...
                <p className="text-gray-500 text-sm mb-6 max-w-md mx-auto">
                    The simplest way to manage, discover, and host world-class events in your city.
                </p>
